...
router.post("/", async (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      subject: "Password reset request for MergeMe account!",
      html: `<p>Hey ${user.name
        .split(" ")[0]
        .toString()}, There was a request for password reset for your MergeMe account!. <a href=${href}>Click this link to reset the password </a>   </p>
